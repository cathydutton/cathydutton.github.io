...
To work effectively a detailed understanding of key CSS features is essential. A misunderstanding of these features often leads to out of control CSS.


#### Cascade
In cases where there are multiple style rules the cascade determines which property should be applied.
