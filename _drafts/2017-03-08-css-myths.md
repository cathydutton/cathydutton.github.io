...
Progressive enhancement promotes the idea of adding extra functionality for modern browsers and devices, only after delivering core content and functionality to all bowsers and devices.

This differs slightly from graceful degradation which focuses on delivering the all singing all dancing soloution first and then provides fallbacks for older browsers. 
