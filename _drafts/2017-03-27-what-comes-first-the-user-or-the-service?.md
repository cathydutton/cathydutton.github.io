...
<p>However there are also some drawbacks to opening the form with product related questions:</p>
...
<p>Experiment by mapping out all the possible user journeys using the key questions you identified as starting points. Use colour-coded post-it notes to highlight positive and negative aspects for each user journey in each sequence.</p>
